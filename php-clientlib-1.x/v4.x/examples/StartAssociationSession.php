 ...
 */
class StartAssociationSession {
  /**
   * Starts an association session.
   *
  ...
  public static function run($service, $websiteUrl, $productCodes = ["afc", "afg", "afmc", "afs", "afv"]) {
    ...
    printf("Association with ID \"%s\" and redirect URL \"%s\" was started.\n",
        $result->getId(), $result->getRedirectUrl());
